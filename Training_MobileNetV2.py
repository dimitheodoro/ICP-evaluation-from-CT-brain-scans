...
from My_model_MobileNetV2 import MultipleInputsMobileNetV2
...
model =MultipleInputsMobileNetV2(input_shape=(128,128,120),sex_label_shape=(1,),age_label_shape=(1,),GCS_label_shape=(1,),
...
for layer in distributed_model.layers[17:18]:    #layer in vgg.layers[:-5]:
...
if SAVE:
    plt.savefig("/raid/theodoropoulos/PhD/Results/whole image/128_128_120/AUC/MobileNetV2_loss_acc_AUC(120,128,128).png")
    distributed_model.save("/raid/theodoropoulos/PhD/Results/whole image/128_128_120/AUC/MobileNetV2_120_128_128.keras")
