...
from My_model_DenseNet201 import MultipleInputsDenseNet201
...
model =MultipleInputsDenseNet201(input_shape=(128,128,120),sex_label_shape=(1,),age_label_shape=(1,),GCS_label_shape=(1,),
...
if SAVE:
    plt.savefig("/raid/theodoropoulos/PhD/Results/whole image/128_128_120/AUC/DenseNet201_loss_acc_AUC(120,128,128).png")
    distributed_model.save("/raid/theodoropoulos/PhD/Results/whole image/128_128_120/AUC/DenseNet201_120_128_128.keras")
