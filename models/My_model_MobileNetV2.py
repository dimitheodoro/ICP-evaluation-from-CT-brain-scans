...
def MultipleInputsMobileNetV2(input_shape, sex_label_shape, age_label_shape, GCS_label_shape, 
    ...
    base_model = MobileNetV2(input_shape=(128, 128, 123, 3), weights='imagenet',include_top=False)
    base_model = base_model(merge)
    print(f"Shape after MobileNetV2: {base_model.shape}")
...
#     model = MultipleInputsDenseConvNex(input_shape, sex_label_shape, age_label_shape, GCS_label_shape)
#     model.summary()
